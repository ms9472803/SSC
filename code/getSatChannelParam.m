...
for n = 1:NumCSV
    ...
    AAngleInfo{n} = LinkInformation.RcvrAzimuth_deg_';                         % deg Azimuth Angle (Excluding Doppler Shift)
    AAngle{n} = mod((AAngleInfo{n} + 360), 360) / 360;                         % Format in 2pi
...
save('SatChannelParam.mat','EIRP','AGain','Fc','PL','AAngle','EAngle','AAngleInfo','EAngleInfo','Name');
